...
The following is a set of guidelines for contributing to base. 
...
The base team strives to create a
...
Please use our [Issue Tracker](https://github.com/lmodel/base/issues/) for reporting problems with the ontology. 
